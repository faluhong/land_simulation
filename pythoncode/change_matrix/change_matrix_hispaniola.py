...
from change_matrix.util_read_hispaniola_lc import land_cover_map_read_hispaniola
...
@click.command()
@click.option('--predict_flag', type=str, default='forecast', help='the prediction flag, forecast or hindcast')
@click.option('--country_flag', type=str, default='hispaniola', help='the country flag, haiti or dr or hispaniola')
def main(predict_flag, country_flag):
    ...
    # define the change matrix for adjacent years
    ...
    # for i_year in range(1, 2):
        ...
        img_lc_t1 = land_cover_map_read_hispaniola(list_year[i_year], country_flag)
        img_lc_t2 = land_cover_map_read_hispaniola(list_year[i_year + 1], country_flag)
        ...
        img_lc_start = land_cover_map_read_hispaniola(list_year[0],country_flag)
        transition_prob_matrix_accumulate_direct[i_year + 1] = transition_prob_matrix_two_times(img_lc_start, img_lc_t2).transition_prob_matrix

    output_path = join(rootpath_project, 'results', 'change_matrix')
