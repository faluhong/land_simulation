"""
    use bootstrapping to determine the variance of the forecast land cover percentage
"""
...
def read_forecast_lc_pct_file(landcover_version, list_observe_year, country_flag, predict_flag='forecast', matrix_folder=None):
    ...
    df_observe = read_obs_pct_file(list_observe_year=list_observe_year,
...
if __name__ == '__main__':
    ...
    n_iterations = 100    # the number of bootstrapping iterations, change to get more precision confidence intervals
