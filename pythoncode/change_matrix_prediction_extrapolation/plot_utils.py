...
def plot_change_proportion_single_cell(transition_prob_matrix,
                                       landcover_id_from,
                                       landcover_id_to,
    ...
    """
        ...
        :param transition_prob_matrix:
        :param landcover_id_from:
        :param landcover_id_to:
        :param list_year:
...
def ensemble_plot_change_proportion_single_cell(transition_prob_matrix, landcover_id, landcover_flag='from',
                                                list_year=np.arange(1996, 2023),
                                                x_axis_interval=3.0,
                                                landcover_system=None):
...
def line_plot_each_predict_cell(landcover_id_from,
                                landcover_id_to,
                                list_observe_year,
                                list_predict_year,
    ...
    """
    plot the observe and predict change proportion of five prediction methods for one cell in the change matrix
    for example, plot the change proportion from primary wet forest to primary wet forest, i.e., stay the same
    """
...
def plot_change_matrix(change_matrix,
                       x_label,
                       y_label,
                       title=None,
                       vmin=0,
...
def plot_predict_pct(list_observe_year,
    ...
    """    plot the predicted land cover percentage of each land cover type, the x axis is the year, the y axis is the land cover percentage
...
def plot_predict_pf_percentage(list_observe_year,
                               ...
                               output_folder=None):
    """
        plot the primary forest percentage prediction using different approaches, including Markov Chain, auto ARIMA, complete linear regression, and partial linear regression
    ...
    plt.plot(list_observe_year, (df_observe['2 Primary wet forest %'].values + df_observe['3 Primary dry forest %'].values) * 100,
             label='Primary forest observe', color=np.array([29, 101, 51, 255]) / 255, linestyle='dashed')

    plt.plot(list_prediction_year, (df_predict_mk_chain['2 Primary wet forest %'].values + df_predict_mk_chain['3 Primary dry forest %'].values) * 100,
             label='Markov Chain predict', color='#d7191c')

    plt.plot(list_prediction_year, (df_predict_arima['2 Primary wet forest %'].values + df_predict_arima['3 Primary dry forest %'].values) * 100,
             label='Arima predict', color='#fdae61')

    plt.plot(list_prediction_year, (df_predict_complete_reg['2 Primary wet forest %'].values + df_predict_complete_reg['3 Primary dry forest %'].values) * 100,
             label='Complete linear regression predict', color='#5e3c99')

    plt.plot(list_prediction_year, (df_predict_partial_reg['2 Primary wet forest %'].values + df_predict_partial_reg['3 Primary dry forest %'].values) * 100,
...
if __name__ == '__main__':
    ...
    plot_change_proportion_single_cell(transition_prob_matrix,
                                       landcover_id_from,
                                       landcover_id_to,
                                       list_year=np.arange(1996, 2023),
                                       x_axis_interval=3.0,
    ...
    ensemble_plot_change_proportion_single_cell(transition_prob_matrix,
                                                landcover_id=2,
                                                landcover_flag='from',
                                                list_year=np.arange(1996, 2023),
                                                x_axis_interval=3.0,
